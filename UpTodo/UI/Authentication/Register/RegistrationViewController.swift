...
class RegistrationViewController: UIViewController {
    ...
    private enum UIConstants {
        ...
        static let passwordTextFieldToLoginButtonOffset: CGFloat = 40
        static let orLabelOffset: CGFloat = 40
    ...
    private lazy var loginWithGoogleButton: UIButton = {
        ...
        button.configuration?.title = "Register with Google"
    ...
    private lazy var loginWithAppleButton: UIButton = {
        ...
        button.configuration?.title = "Register with Apple"
    ...
    private lazy var loginOfferButton: UIButton = {
        let button = UIButton()
...
private extension RegistrationViewController {
    func initialization() {
        ...
        passwordTextField.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.top.equalTo(usernameTextField.snp.bottom).offset(UIConstants.textFieldOffset)
            make.width.equalTo(UIConstants.textFieldWidth)
            make.height.equalTo(UIConstants.textFieldHeight)
        }
        ...
        passwordConfirmTextField.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.top.equalTo(passwordTextField.snp.bottom).offset(UIConstants.textFieldOffset)
            make.width.equalTo(UIConstants.textFieldWidth)
            make.height.equalTo(UIConstants.textFieldHeight)
        }
        ...
        passwordConfirmLabel.snp.makeConstraints { make in
            make.leading.equalTo(passwordConfirmTextField.snp.leading)
            make.bottom.equalTo(passwordConfirmTextField.snp.top).offset(UIConstants.textFieldToLabelOffset)
        }
        ...
        loginButton.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.top.equalTo(passwordConfirmTextField.snp.bottom).offset(UIConstants.passwordTextFieldToLoginButtonOffset)
            make.height.equalTo(UIConstants.buttonHeight)
            make.width.equalTo(UIConstants.buttonWidth)
        }

        view.addSubview(loginOfferButton)

        loginOfferButton.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
        ...
        loginWithAppleButton.snp.makeConstraints { make in
            make.centerX.equalToSuperview()
            make.bottom.equalTo(loginOfferButton.snp.top).offset(-(UIConstants.anotherLoginButtonsOffset * 2))
            make.width.equalTo(UIConstants.buttonWidth)
            make.height.equalTo(UIConstants.buttonHeight)
        }
    ...
    @objc func textFieldTextDidChange() {
        if !usernameTextField.text!.isEmpty, passwordTextField.text == passwordConfirmTextField.text, passwordTextField.text!.count > 7 {
